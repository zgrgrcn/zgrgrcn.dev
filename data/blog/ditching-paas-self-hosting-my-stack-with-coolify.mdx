...
As someone who spends his workdays engineering high-throughput backend infrastructure, running my own personal stack on a self-hosted platform felt like the natural, fun weekend move. I recently migrated my portfolio (`zgrgrcn.dev`) and companion services to **Coolify** on a lightweight Linux VPS.
...
2. In Coolify's application dashboard, enter your domains:
   ```text
   https://ozgurgurcan.dev, https://www.ozgurgurcan.dev
   ```
