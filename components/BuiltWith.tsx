  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      <div className="flex items-center space-x-1.5">
        <Link
          href="https://nextjs.org?ref=ozgurgurcan.dev"
          title="Next.js"
          aria-label="Next.js"
        ...
        <Link
          href="https://tailwindcss.com?ref=ozgurgurcan.dev"
          title="Tailwind CSS"
        ...
        <Link
          href="https://www.typescriptlang.org?ref=ozgurgurcan.dev"
          title="TypeScript"
        ...
        <Link
          href="https://orm.drizzle.team?ref=ozgurgurcan.dev"
          title="Drizzle ORM"
        ...
        <Link
          href="https://www.postgresql.org?ref=ozgurgurcan.dev"
          title="PostgreSQL"
        ...
        <Link
          href="https://www.docker.com?ref=ozgurgurcan.dev"
          title="Docker"
          aria-label="Docker"
          className="text-gray-500 transition-all duration-150 hover:scale-110 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
        >
        ...
        <Link
          href="https://coolify.io?ref=ozgurgurcan.dev"
          title="Coolify"
          aria-label="Coolify"
          className="text-gray-500 transition-all duration-150 hover:scale-110 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
        >
        ...
        <Link
          href="https://www.cloudflare.com?ref=ozgurgurcan.dev"
          title="Cloudflare"
